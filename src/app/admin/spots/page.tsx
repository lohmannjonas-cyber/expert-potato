...
export default async function AdminSpotsPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-6">
        <p className="text-sm font-black uppercase tracking-normal text-lagoon">Verwaltung</p>
        <h1 className="mt-1 text-3xl font-black text-slate-950">Spotverwaltung</h1>
      </div>
