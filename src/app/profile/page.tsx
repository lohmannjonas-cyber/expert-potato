...
export default async function ProfilePage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-6">
        <p className="text-sm font-black uppercase tracking-normal text-lagoon">Fahrerprofil</p>
        <h1 className="mt-1 text-3xl font-black text-slate-950">Vorlieben und Favoriten</h1>
      </div>
      ...
      {session ? (
        <>
          ...
          <section className="mt-8 rounded-lg border border-slate-200 bg-white p-5 shadow-soft">
            <h2 className="font-black text-slate-950">Lieblingsspots</h2>
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-soft">
          <p className="text-slate-700">Melde dich an, um Fahrerprofil, Heimatort und Lieblingsspots zu speichern.</p>
